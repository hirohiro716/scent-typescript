...
export default class StringObject {
     ...
     * @returns このインスタンス。
     */
    public set(value: any): StringObject {
        let stringValue = "";
        if (typeof value !== "undefined" && value !== null) {
     ...
     * @returns このインスタンス。
     */
    public append(addition: any): StringObject {
     ...
     * @returns このインスタンス。
     */
    public prepend(addition: any): StringObject {
        if (typeof addition !== "undefined" && addition !== null) {
     ...
     * @returns このインスタンス。
     */
    public extract(startIndex: number, endIndex?: number): StringObject;
     ...
     * @returns このインスタンス。
     */
    public extract(regex: string): StringObject;
     ...
     * @returns このインスタンス。
     */
    public replace(regex: string, replacement: string): StringObject {
     ...
     * @returns このインスタンス。
     */
    public replaceTab(replacement: string): StringObject {
     ...
     * @returns このインスタンス。
     */
    public removeMeaninglessDecimalPoint(): StringObject {
     ...
     * @returns 
     */
    public equals(comparison: any): boolean {
    ...
    *[Symbol.iterator]() {
     ...
     */
    public repeat(numberOfRepeats: number): StringObject {
        const value = this.joinAndResetParts();
        for (let index: number = 0; index < numberOfRepeats - 1; index++) {
     ...
     * @returns 
     */
    public splitToStrings(regexDelimiter: string): string[] {
     ...
     * @returns 
     */
    public split(regexDelimiter: string): StringObject[] {
     ...
     * @returns 
     */
    public static from(value: any): StringObject {
        return new StringObject(value);
    }

    private static readonly randomBaseCharacters = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890";
     ...
     * @returns 
     */
    public static join(values: any[], separator?: string): StringObject {
     ...
     * @returns 
     */
    public static queryString(formData: FormData): StringObject {
        const stringObject = new StringObject();
     ...
     * 半角を全角に置き換えるための連想配列。
     */
    private static NARROW_TO_WIDE_MAP: Record<string, string> = {
        "a": "ａ",
        "b": "ｂ",
        "c": "ｃ",
        "d": "ｄ",
     ...
     * 全角を半角に置き換えるための連想配列。
     */
    private static WIDE_TO_NARROW_MAP: Record<string, string> = {
        "ａ": "a",
        "ｂ": "b",
        "ｃ": "c",
        "ｄ": "d",
     ...
     */
    private static HIRAGANA_TO_KATAKANA_MAP: Record<string, string> = {
        "ぁ": "ァ",
        "あ": "ア",
        "ぃ": "ィ",
        "い": "イ",
     ...
     */
    private static KATAKANA_TO_HIRAGANA_MAP: Record<string, string> = {
        "ァ": "ぁ",
        "ア": "あ",
        "ィ": "ぃ",
        "イ": "い",
     ...
     */
    private static JAPANESE_LOWER_TO_UPPER_MAP: Record<string, string> = {
        "ぁ": "あ",
        "ぃ": "い",
        "ぅ": "う",
        "ぇ": "え",
     ...
     */
    private static JAPANESE_UPPER_TO_LOWER_MAP: Record<string, string> = {
        "あ": "ぁ",
        "い": "ぃ",
        "う": "ぅ",
        "え": "ぇ",
