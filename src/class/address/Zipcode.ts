...
export default class Zipcode {
     ...
     * JISと都道府県のオブジェクト。
     */
    public static readonly jisAndPrefectures: Record<number, string> = {
        1: "北海道",
        2: "青森県",
        3: "岩手県",
        4: "宮城県",
     ...
     * 都道府県を取得する。
     */
    public static getPrefectures(): string[] {
     ...
     * @returns 
     */
    public static async fetchAddress(zipcode: string): Promise<{prefecture: string, address: string}> {
        ...
        const values: any[] = data[formattedZipcode.toString()];
